...
> 登入後預設顯示 📅 行事曆（2026-08-13 Sarah 定案）。
...
> 🔑 **預設帳號：`admin / admin123`**（測試帳號）——正式使用請登入後從 topbar「⚙️ 設定」→ 設定中心「修改密碼」更換
