...
from frontend_test_support import (
    ...
    LOGIN,
    NOTIFICATIONS_JS,
    PDF_PREVIEW_BUTTON_JS,
    PETTY_CASH_CAPABILITY_RUNTIME_JS,
    PETTY_CASH_CSS,
    PETTY_CASH_ENGINEERING_CSS,
    PETTY_CASH_ENGINEERING_MODAL_JS,
    PETTY_CASH_MODAL_JS,
    PETTY_CASH_RENDER_JS,
    PETTY_CASH_REPORTS_CSS,
    PETTY_CASH_UNPRICED_RUNTIME_JS,
    PHOTO_JS,
    PREPARED_RENDER_JS,
    QUOTATION_HISTORY_PAGINATION_JS,
    QUOTATION_PERMISSION_RUNTIME_JS,
    QUOTATION_RENDER_JS,
    QUOTATION_UPLOAD_CAPABILITY_RUNTIME_JS,
    QUOTATION_UPLOAD_CSS,
    QUOTATION_UPLOAD_RENDER_JS,
    SETTINGS_HTML,
    SETTINGS_JS,
    SIGNED_REPORTS_CSS,
    SIGNED_REPORTS_RENDER_JS,
    SIGNED_REPORT_CAPABILITY_RUNTIME_JS,
    STATIC,
    STOCKOUT_MODAL_JS,
    STOCKOUT_RENDER_JS,
    STOCKTAKE_JS,
...
def test_work_progress_frontend_create_uses_editable_uploader_and_calendar_readonly_contract():
    ...
    assert "地址" in js and "指定服務" in js and "行事曆備註" in js
